...
chrome.identity.getAuthToken(
	...
	function(){
	  //load Google's javascript client libraries
		...
		console.log('inside google authtooken')
	}
);
...
function loadScript(url){
  var request = new XMLHttpRequest();
    ...
    console.log('token is '+request.responseText)
	};
...
function authorize(){
  gapi.auth.authorize(
		{
			client_id: '356495425228-khtibtb56p72q7qc2icubm6hs471hcld.apps.googleusercontent.com',
			immediate: true,
